...
class __TwigTemplate_ea4dfa679c53211cec2488b5a7789faec26c83690bd381933414e9ccb260dae6 extends Twig_Template
{
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 44
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("butmarque_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
            ...
            echo "\">show</a>
                    ...
                    <li>
                        <a href=\"";
            // line 52
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("butmarque_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">edit</a>
                    </li>
                </ul>
                </td>
    ...
    {
        return array (  118 => 63,  111 => 58,  99 => 52,  93 => 49,  86 => 45,  80 => 44,  77 => 43,  73 => 42,  34 => 6,  31 => 5,  28 => 3,  11 => 1,);
    }
}
...
/* {% block body -%}*/
/* */
/*     <section id="sp-page-title"><div class="row"><div id="sp-title" class="col-sm-12 col-md-12"><div class="sp-column ">*/
/*                     <div class="sp-page-title"style="background-image: url('{{ asset('template/images/demo/slider/slider2.jpg') }}')"> */
/*                         <div class="container"><h2>Bercelona</h2>*/
/*                                                                                     <ol class="breadcrumb">*/
/*                                                                                         <span>You are here: &#160;</span><li><a href="../index-2.html" class="pathway">Home</a></li><li><a href="#" class="pathway">Club List</a></li><li class="active">Bercelona</li></ol>*/
/*                                                                                 </div></div></div></div></div></section>*/
...
/*             <tr>*/
/*                 <td><a href="{{ path('butmarque_show', { 'id': entity.id }) }}">{{ entity.minute }}</a></td>*/
/*                 <td>{{ entity.id }}</td>*/
/*                 <td>*/
/*                 <ul>*/
/*                     <li>*/
/*                         <a href="{{ path('butmarque_show', { 'id': entity.id }) }}">show</a>*/
/*                     </li>*/
/*                     <li>*/
/*                         <a href="{{ path('butmarque_edit', { 'id': entity.id }) }}">edit</a>*/
/*                     </li>*/
/*                 </ul>*/
/*                 </td>*/
/*             </tr>*/
