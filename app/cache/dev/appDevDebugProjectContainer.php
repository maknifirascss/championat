...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '437ef029a033eba73d26bbdfd2977327d2f4a52d54c1044fd1ef0ec54aa83c82_1' => 'get437ef029a033eba73d26bbdfd2977327d2f4a52d54c1044fd1ef0ec54aa83c821Service',
            ...
            'fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_1' => 'getFefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc41Service',
            'fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_2' => 'getFefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc42Service',
            'fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_3' => 'getFefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc43Service',
    ...
    /**
     * Gets the '437ef029a033eba73d26bbdfd2977327d2f4a52d54c1044fd1ef0ec54aa83c82_1' service.
     *
     ...
     */
    protected function get437ef029a033eba73d26bbdfd2977327d2f4a52d54c1044fd1ef0ec54aa83c821Service()
    {
        return $this->services['437ef029a033eba73d26bbdfd2977327d2f4a52d54c1044fd1ef0ec54aa83c82_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/Projet/championat/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/Projet/championat/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_4964d2ee865bee2ccf70b3eb5aa71a5635e8da548937cdc669b6678a5d45d367');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_4964d2ee865bee2ccf70b3eb5aa71a5635e8da548937cdc669b6678a5d45d367');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4964d2ee865bee2ccf70b3eb5aa71a5635e8da548937cdc669b6678a5d45d367');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\xampp\\htdocs\\Projet\\championat\\src\\Acme\\ChampionatBundle\\Resources\\config\\doctrine' => 'Acme\\ChampionatBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Acme\\ChampionatBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('AcmeChampionatBundle' => 'Acme\\ChampionatBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('C:/xampp/htdocs/Projet/championat/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc41Service()
    {
        return $this->services['fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc42Service()
    {
        return $this->services['fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc43Service()
    {
        return $this->services['fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/Projet/championat/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('437ef029a033eba73d26bbdfd2977327d2f4a52d54c1044fd1ef0ec54aa83c82_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/Projet/championat/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/Projet/championat/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/Projet/championat/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/Projet/championat/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Projet/championat/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/Projet/championat/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/Projet/championat/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_1'), 1 => $this->get('fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_2'), 2 => $this->get('fefbf863cc1d125ddd132cd504487db50ae6765e969615262de9d3cae51afbc4_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/Projet/championat/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/Projet/championat/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\src\\Acme\\ChampionatBundle/Resources/views', 'AcmeChampionat');
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/Projet/championat/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\Projet\\championat\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\xampp\\htdocs\\Projet\\championat\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/Projet/championat/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/Projet/championat/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/Projet/championat/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/Projet/championat/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/Projet/championat/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/Projet/championat/app/logs',
            'kernel.bundles' => array(
                ...
                'AcmeChampionatBundle' => 'Acme\\ChampionatBundle\\AcmeChampionatBundle',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/Projet/championat/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/xampp/htdocs/Projet/championat/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/Projet/championat/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/Projet/championat/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/Projet/championat/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/Projet/championat/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/Projet/championat/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/Projet/championat/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/Projet/championat/app/../web',
            'assetic.variables' => array(

            ),
            'assetic.java.bin' => 'C:\\Program Files (x86)\\Java\\jdk1.8.0_25\\bin\\java.EXE',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/Projet/championat/app/cache/dev/doctrine/orm/Proxies',
